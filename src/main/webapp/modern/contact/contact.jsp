...
<script type="text/javascript" src="//api.map.baidu.com/api?v=2.0&ak=lnDzFsDOZfE1xH7QKd6LYGORREtuWpnC"></script>
<script>
...
<script type="text/javascript">
  ...
  var point = new BMap.Point(113.557854,34.831988);
  ...
  var opts = {
    width : 200,     // 信息窗口宽度
    height: 100,     // 信息窗口高度
    title : "郑州东明家具有限公司" , // 信息窗口标题
    enableMessage:true,//设置允许信息窗发送短息
    message:"买办公家具请联系赵经理18638201889~"
  }
  var infoWindow = new BMap.InfoWindow("地址：河南省郑州市高新区", opts);  // 创建信息窗口对象
